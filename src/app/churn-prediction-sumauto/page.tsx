        ...
        >
          ...
          <div className="text-center mb-16">
            ...
            <div className="flex flex-wrap justify-center gap-4 text-sm text-gray-500">
              ...
              <span>👥 Team: Camila, Dani, Carlos + Mentor Sergio Rozada</span>
                ...
                <div className="space-y-3">
                  <div className="flex items-center">
                    <div className="w-10 h-10 bg-blue-500 rounded-full flex items-center justify-center text-white font-bold text-sm mr-3">
                      ...
                      <div>
                        <div className="font-medium">Camila Mendez</div>
              ...
              <div>
                ...
                <div className="mt-6">
                  ...
                  <div className="bg-white rounded-lg p-3 border border-gray-200">
                    ...
                    <div className="text-xs text-gray-600">Part of applied data science collaboration</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <p className="text-sm text-gray-500">
              This project was conducted as part of an applied data science collaboration<br/>
