  ...
  const contactInfo = [
    {
      ...
      content: 'mendezcamilaitati@gmail.com',
      link: 'mailto:mendezcamilaitati@gmail.com'
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  const socialLinks = [
    {
      ...
      title: 'LinkedIn',
      link: 'https://www.linkedin.com/in/camila-mendez-6878252b0/'
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      title: 'GitHub',
      link: 'https://github.com/MendezCamila'
    }
  ];
          ...
          >
            ...
            <div className="mt-10 text-center">
              <motion.a
                ...
                href="/CamilaMendez_CV.pdf"
                download="CamilaMendez_CV.pdf"
